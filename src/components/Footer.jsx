...
const Footer = ({darkMode, language}) => {
  return (
    <div className = {`bg-gray-100 flex flex-wrap justify-between lg:px-32 ${darkMode ? 'bg-gray-900 text-white' : ''}`}>
      <div className="flex flex-col gap-10 p-20">
        <h6 className="text-4xl w-[400px]">{language === "en" ? "Lets work together on your next product" : "Bir sonraki ürününüz üzerinde birlikte çalışalım."}</h6>
